...
const ICON_OPTIONS = [
  'cash', 'cart', 'car', 'fast-food', 'medical', 'school',
  'home', 'book', 'airplane', 'fitness', 'shirt', 'gift',
  'film', 'bicycle', 'beer', 'cafe', 'card', 'clipboard',
  'lock-closed', 'chatbubble', 'document', 'basket', 'heart'
];
